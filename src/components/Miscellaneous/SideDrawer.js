...
const SideDrawer = () => {
    ...
    const navigate = useNavigate(); // Change to useNavigate instead of history
    const toast = useToast();

    const logoutHandler = () => {
        localStorage.removeItem("userInfo");
        navigate('/'); // Updated for useNavigate
    };
    ...
    //     navigate(`/profile/${userId}`); // Navigate to user profile instead of starting a chat
    //     onClose();
    // };
